...
export const industries: IndustryData[] = [
  ...
  },
  {
    slug: "legal-services",
    name: "法律服務",
    heroTitle: "法律服務 AEO 優化：令 AI 搜尋推薦你嘅律師事務所",
    heroSubtitle: "當客戶問 AI「香港最好嘅商業律師」或「點樣處理勞資糾紛」，你嘅律師事務所需要被推薦。",
    problems: [
      "法律服務高度依賴信任同權威性，但 AI 搜尋正在重新定義「權威」",
      "潛在客戶越來越常用 AI 助手做法律初步研究，然後先搵律師",
      "法律內容嘅合規性要求令 AI 優化更加複雜",
      "大型律師事務所已經開始投資 AEO，中小型事務所需要盡快追上",
    ],
    solutions: [
      "LegalService Schema 標記，令 AI 引擎精準理解你嘅專業範疇",
      "法律知識內容 AEO 化，將你嘅專業知識轉化為 AI 可引用嘅權威資源",
      "律師個人品牌 AI 能見度建設，確保 AI 推薦「人」而唔只係「所」",
      "案例分析結構化呈現，用成功案例建立 AI 系統中嘅可信度",
    ],
    stats: [
      { value: "+290%", label: "AI 搜尋能見度" },
      { value: "38 日", label: "首次 AI 推薦" },
      { value: "+180%", label: "查詢量增長" },
    ],
    faqs: [
    ...
    metaTitle: "法律服務 AEO 優化 | AI 搜尋推薦你嘅律師事務所 - SurfIO",
    metaDescription: "SurfIO 幫律師事務所喺 ChatGPT、Google AI 被推薦。專業法律 AEO 策略，合規審查，38 日內首次 AI 推薦。",
  },
  {
    slug: "healthcare",
    name: "醫療服務",
