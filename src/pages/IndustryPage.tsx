...
export default function IndustryPage() {
  ...
  return (
    <div className="pt-[90px] pb-16">
      ...
      {/* Internal links to other industries */}
      <section className="max-w-[1100px] mx-auto px-5 md:px-10 mt-16">
        <div className="border-t border-gray-200 pt-10">
          <h3 className="text-[16px] font-bold text-gray-900 mb-4">其他行業 AEO 方案</h3>
...
function NotFound() {
  return (
    <div className="pt-[120px] pb-20 text-center">
      ...
      <p className="text-gray-600 mb-6">呢個行業頁面唔存在。</p>
